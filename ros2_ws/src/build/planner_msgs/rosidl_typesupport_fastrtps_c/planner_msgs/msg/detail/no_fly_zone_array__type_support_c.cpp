...
#include "planner_msgs/msg/detail/no_fly_zone_array__rosidl_typesupport_fastrtps_c.h"
...
#include "planner_msgs/msg/detail/no_fly_zone__functions.h"  // zones
...
using _NoFlyZoneArray__ros_msg_type = planner_msgs__msg__NoFlyZoneArray;
  ...
  planner_msgs__msg__NoFlyZoneArray * ros_message)
{
  ...
  // Field name: zones
  {
    ...
    if (ros_message->zones.data) {
      planner_msgs__msg__NoFlyZone__Sequence__fini(&ros_message->zones);
    }
    if (!planner_msgs__msg__NoFlyZone__Sequence__init(&ros_message->zones, size)) {
      fprintf(stderr, "failed to create array for field 'zones'");
      return false;
    }
    auto array_ptr = ros_message->zones.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_planner_msgs__msg__NoFlyZoneArray(
  ...
  size_t current_alignment)
{
  const _NoFlyZoneArray__ros_msg_type * ros_message = static_cast<const _NoFlyZoneArray__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = planner_msgs__msg__NoFlyZoneArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const planner_msgs__msg__NoFlyZoneArray * ros_message = static_cast<const planner_msgs__msg__NoFlyZoneArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_planner_msgs__msg__NoFlyZoneArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  planner_msgs__msg__NoFlyZoneArray * ros_message = static_cast<planner_msgs__msg__NoFlyZoneArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_planner_msgs__msg__NoFlyZoneArray(cdr, ros_message);
}

static uint32_t _NoFlyZoneArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_planner_msgs__msg__NoFlyZoneArray(
...
static size_t _NoFlyZoneArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_planner_msgs__msg__NoFlyZoneArray(
...
static message_type_support_callbacks_t __callbacks_NoFlyZoneArray = {
  "planner_msgs::msg",
  "NoFlyZoneArray",
...
static rosidl_message_type_support_t _NoFlyZoneArray__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NoFlyZoneArray,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, planner_msgs, msg, NoFlyZoneArray)() {
  return &_NoFlyZoneArray__type_support;
}
