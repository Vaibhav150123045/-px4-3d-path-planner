...
struct PlanPath_Request_
{
  ...
  using _goal_type =
    geometry_msgs::msg::PointStamped_<ContainerAllocator>;
  _goal_type goal;
  using _altitude_min_type =
    double;
  _altitude_min_type altitude_min;
  using _altitude_max_type =
    double;
  _altitude_max_type altitude_max;
  using _no_fly_zones_type =
  ...
  _no_fly_zones_type no_fly_zones;
  ...
  Type & set__altitude_min(
    const double & _arg)
  {
    this->altitude_min = _arg;
    return *this;
  }
  Type & set__altitude_max(
    const double & _arg)
  {
    this->altitude_max = _arg;
    return *this;
  }
  Type & set__no_fly_zones(
  ...
  bool operator==(const PlanPath_Request_ & other) const
  {
    ...
    if (this->altitude_min != other.altitude_min) {
      return false;
    }
    if (this->altitude_max != other.altitude_max) {
      return false;
    }
    if (this->no_fly_zones != other.no_fly_zones) {
      return false;
    }
    return true;
  }
