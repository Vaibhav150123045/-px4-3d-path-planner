  ...
  std::ostream & out)
{
  ...
  {
    out << "altitude_min: ";
    rosidl_generator_traits::value_to_yaml(msg.altitude_min, out);
    out << ", ";
  }
  ...
  {
    out << "altitude_max: ";
    rosidl_generator_traits::value_to_yaml(msg.altitude_max, out);
    out << ", ";
  }

  // member: no_fly_zones
  {
    if (msg.no_fly_zones.size() == 0) {
      out << "no_fly_zones: []";
    } else {
      out << "no_fly_zones: [";
      size_t pending_items = msg.no_fly_zones.size();
      for (auto item : msg.no_fly_zones) {
