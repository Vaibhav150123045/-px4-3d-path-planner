...
#include "geometry_msgs/msg/detail/point__functions.h"  // max_corner, min_corner
  ...
  planner_msgs__msg__NoFlyZone * ros_message)
{
  // Field name: min_corner
  {
    cdr_deserialize_geometry_msgs__msg__Point(cdr, &ros_message->min_corner);
  }

  // Field name: max_corner
  {
    cdr_deserialize_geometry_msgs__msg__Point(cdr, &ros_message->max_corner);
  }
