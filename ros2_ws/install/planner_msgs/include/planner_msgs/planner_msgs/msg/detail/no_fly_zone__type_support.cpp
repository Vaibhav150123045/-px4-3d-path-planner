...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NoFlyZone_message_member_array[2] = {
  {
    "min_corner",  // name
    ...
    offsetof(planner_msgs::msg::NoFlyZone, min_corner),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planner_msgs::msg::NoFlyZone, max_corner),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
