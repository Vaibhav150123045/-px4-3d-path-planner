...
size_t planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__size_function__PlanPath_Request__no_fly_zones(
...
const void * planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__get_const_function__PlanPath_Request__no_fly_zones(
...
void * planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__get_function__PlanPath_Request__no_fly_zones(
...
void planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__fetch_function__PlanPath_Request__no_fly_zones(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const planner_msgs__msg__NoFlyZone * item =
    ((const planner_msgs__msg__NoFlyZone *)
    planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__get_const_function__PlanPath_Request__no_fly_zones(untyped_member, index));
  planner_msgs__msg__NoFlyZone * value =
    (planner_msgs__msg__NoFlyZone *)(untyped_value);
  *value = *item;
}

void planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__assign_function__PlanPath_Request__no_fly_zones(
  void * untyped_member, size_t index, const void * untyped_value)
{
  planner_msgs__msg__NoFlyZone * item =
    ((planner_msgs__msg__NoFlyZone *)
    planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__get_function__PlanPath_Request__no_fly_zones(untyped_member, index));
  const planner_msgs__msg__NoFlyZone * value =
    (const planner_msgs__msg__NoFlyZone *)(untyped_value);
  *item = *value;
}

bool planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__resize_function__PlanPath_Request__no_fly_zones(
...
static rosidl_typesupport_introspection_c__MessageMember planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__PlanPath_Request_message_member_array[5] = {
  {
    "start",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planner_msgs__srv__PlanPath_Request, altitude_min),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planner_msgs__srv__PlanPath_Request, altitude_max),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planner_msgs__srv__PlanPath_Request, no_fly_zones),  // bytes offset in struct
    NULL,  // default value
    planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__size_function__PlanPath_Request__no_fly_zones,  // size() function pointer
    planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__get_const_function__PlanPath_Request__no_fly_zones,  // get_const(index) function pointer
    planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__get_function__PlanPath_Request__no_fly_zones,  // get(index) function pointer
    planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__fetch_function__PlanPath_Request__no_fly_zones,  // fetch(index, &value) function pointer
    planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__assign_function__PlanPath_Request__no_fly_zones,  // assign(index, value) function pointer
    planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__resize_function__PlanPath_Request__no_fly_zones  // resize(index) function pointer
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, planner_msgs, srv, PlanPath_Request)() {
  ...
  planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__PlanPath_Request_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, PointStamped)();
  planner_msgs__srv__PlanPath_Request__rosidl_typesupport_introspection_c__PlanPath_Request_message_member_array[4].members_ =
...
static rosidl_typesupport_introspection_c__MessageMember planner_msgs__srv__PlanPath_Response__rosidl_typesupport_introspection_c__PlanPath_Response_message_member_array[4] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(planner_msgs__srv__PlanPath_Response, planning_time_ms),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, planner_msgs, srv, PlanPath_Response)() {
  planner_msgs__srv__PlanPath_Response__rosidl_typesupport_introspection_c__PlanPath_Response_message_member_array[0].members_ =
